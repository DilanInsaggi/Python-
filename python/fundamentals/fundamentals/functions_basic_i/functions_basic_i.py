...
#aqui la respuesta es 5 ya que tiene que imprimir number_of_food_groups y el valor de eso es retun 5
...
# "number_of_days_in_a_week_silicon_or_triangle_sides" parace ser una cadena de carracteres y no una funcion, y la respuesta es 5
...
# la respuesta es 5  ya que esta imprimiendo number_of_books_on_hold y el valor de ese retorno es 5 
...
#la respuesta es 5 porque el return da numero 5 y con el print estan imprimiendo el number_of_fingers
